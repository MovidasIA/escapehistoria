...
// Sorting order for 5ºB (alternating groups for drama)
const SORTING_ORDER = [
  "Miguel", "Vega D.", "Hamza", "Lara",
  "Jorge", "Daniel", "Álvaro", "Ángel",
  "Dara", "Vega P.", "Rocío", "Valeria",
  "Rafa", "Hind", "Kathe", "Saray",
  "Josías", "Mauro", "Guillermo", "Cristian",
  "Alexa"
];

// All student names for 5ºB
const ALL_NAMES = [
  "Miguel", "Jorge", "Dara", "Rafa", "Josías",
  "Vega D.", "Daniel", "Vega P.", "Hind", "Mauro",
  "Hamza", "Álvaro", "Rocío", "Kathe", "Guillermo", "Alexa",
  "Lara", "Ángel", "Valeria", "Saray", "Cristian"
];
...
export default function ClassB() {
  ...
  return (
    <div className="app-container relative w-full h-screen overflow-hidden bg-neutral-950" data-testid="class-b-page">
